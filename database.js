...
const Sequelize = require('sequelize');
require('dotenv/config');
const sequelize = new Sequelize("postgres://oegfitrzdodecg:46739d82d1c2494896c7c730565886e0765d543bc8e13571626de1ad90650735@ec2-52-73-199-211.compute-1.amazonaws.com:5432/d815f7vv6rutqf?ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory")
